...
export const articles: Article[] = [
  { slug: "is-your-teen-burned-out", title: "Is Your Teen Burned Out? The Warning Sign Most Parents Never Notice", audience: "For Parents", summary: "Burnout isn't always visible. Sometimes it hides behind good grades. Sometimes it hides behind responsibility. Sometimes it hides behind a smile.", author: "Ikigai Teen", pdfUrl: "", readTime: "4 min read", publishedOn: "20/06/2026", content: [ { type: "image", src: websiteBlog1Image, alt: "Teen burnout illustration" }, { type: "raw", text: stripLeadingTitle(articleBodies["is-your-teen-burned-out"], "Is Your Teen Burned Out? The Warning Sign Most Parents Never Notice") } ] },
  { slug: "stress-vs-burnout-in-teens", title: "The Difference Between Stress and Burnout in Teenagers: When \"Busy\" Becomes \"Empty\"", audience: "For Parents", summary: "How to tell if your teen is stressed or burned out and what to do next.", author: "Ikigai Teen", pdfUrl: "", readTime: "4 min read", publishedOn: "27/06/2026", content: [ { type: "image", src: websiteBlog2Image, alt: "Stress vs Burnout illustration" }, { type: "raw", text: stripLeadingTitle(articleBodies["stress-vs-burnout-in-teens"], "The Difference Between Stress and Burnout in Teenagers: When \"Busy\" Becomes \"Empty\"") } ] },
