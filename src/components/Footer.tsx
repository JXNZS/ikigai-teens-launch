...
const Footer = () => {
  ...
  const getChildPath = (groupLabel: string, childLabel: string, fallbackPath: string) => {
    ...
    if (groupLabel === "Resources" && childLabel === "Upcoming Events") {
  ...
  return (
    <footer id="contact" className="footer-theme-legacy bg-card border-t border-border py-8 md:py-12 scroll-mt-20">
      <div className="container mx-auto px-4 md:px-6">
              ...
              {navItems.map((group) => (
                <div key={group.label}>
                  ...
                  {openDropdown === group.label && (
                    <div className="mt-1 md:mt-2 pl-3 border-l border-border/70 space-y-1">
        ...
        <div className="mt-8 md:mt-10 pt-6 md:pt-6 border-t border-border/70 flex items-center justify-center">
