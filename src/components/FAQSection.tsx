...
const faqItems: FAQItem[] = [
  {
    question: "What Makes Ikigai Teen differ",
    points: [
      {
...
const FAQSection = () => {
  ...
  return (
    <section ref={ref} className="py-6 md:py-10 bg-[hsl(25_83%_93%_/_0.8)]">  
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <div className="rounded-lg md:rounded-2xl border border-border/60 bg-card p-4 md:p-6">
