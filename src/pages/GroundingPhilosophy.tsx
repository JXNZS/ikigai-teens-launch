...
const principles = [
  "Ikigai - discovering meaning and direction in life by aligning one’s strengths, interests, values, and contribution to the world.",
  "Kaizen - the practice of small, consistent improvements that lead to lasting personal growth.",
  "Shoshin - the beginner’s mind, encouraging curiosity, openness, and the willingness to learn without ego.",
  "Hansei - thoughtful reflection and self-awareness, helping teens learn from experiences and make wiser decisions.",
  "Kintsugi - the idea that imperfections and setbacks can strengthen character and become part of one’s unique story.",
];
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            <article className="rounded-xl border border-border/60 bg-card/70 p-6 md:p-8 space-y-6">
              <div className="space-y-3">
                <h2 className="text-2xl md:text-3xl font-display font-semibold text-foreground">Philosophy</h2>
              ...
              <div className="space-y-4 border-t border-border/50 pt-6">
                {principles.map((principle) => (
                  <p key={principle} className="text-sm md:text-base text-muted-foreground leading-relaxed font-body">
                    {principle}
                  </p>
                ))}
              </div>
