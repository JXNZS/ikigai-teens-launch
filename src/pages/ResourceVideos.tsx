            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {videos.map((video) => (
                <a
                  ...
                  className="rounded-xl border border-border/60 bg-card/70 overflow-hidden hover:bg-card transition-colors"
                >
                  ...
                  <div className="p-4">
                    ...
                    <h2 className="text-lg font-display font-semibold text-foreground leading-snug">{video.title}</h2>
