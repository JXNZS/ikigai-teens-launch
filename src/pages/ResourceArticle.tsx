        ...
        <section className="py-10 md:py-12 lg:py-14 bg-background">
          <div className="container mx-auto px-4 md:px-6 max-w-5xl">
            {article.content && article.content.length > 0 ? (
              <article className="rounded-xl border border-border/60 bg-[hsl(42_38%_88%_/_0.8)] [--foreground:195_26%_16%] [--muted-foreground:195_16%_42%] [--border:152_20%_86%] p-6 md:p-8 mb-14 space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {moreArticles.map((item) => (
                  <Link
                    ...
                    className="rounded-xl border border-border/60 bg-[hsl(42_38%_88%_/_0.8)] [--foreground:195_26%_16%] [--muted-foreground:195_16%_42%] [--border:152_20%_86%] p-5 hover:border-primary/40 transition-colors"
                  >
