...
const NotFound = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 md:px-6">
      <div className="w-full max-w-xl rounded-2xl border border-border/60 bg-[hsl(42_38%_88%_/_0.8)] [--foreground:195_26%_16%] [--muted-foreground:195_16%_42%] [--border:152_20%_86%] p-8 text-center shadow-sm">
